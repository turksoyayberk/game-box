...
public class Level3  extends Application {
    ...
    private int score = 0;
    private Button[] levelButtons = new Button[36];
    private int x[] = new int[36];
    private int y[] = new int[36];
    private int hp[] = new int[36];
    private int totalScore = 0;

    Label infoText = new Label();
    Label scoreText = new Label("" + totalScore);
    Label highScoreText = new Label("High Score: " + highScore3);
    ...
    public Level3(int highScore1, int highScore2, int highScore3, int highScore4, int highScore5) {
        ...
        for (int q = 0; q < levelButtons.length; q++) {
            ...
            if (event.getSource() == levelButtons[q]) {
                ...
                if (i == levelButtons.length) {
                    ...
                    highScoreText.setText("High Score:" + highScore3);
                }
            }
        }
    }
    Stage stage3 = new Stage();//high score verisini tutmak için
    public void NextLevel()
    {
        Level4 level4Scene = new Level4(highScore1, highScore2, highScore3, highScore4, highScore5);
        level4Scene.start(stage3);
    }
    public void start(Stage stage) {
        ...
        ///Üst taraf
        Label levelText = new Label("Level #3");
        ...
        Rectangle notDestroyedBoxes[] = new Rectangle[64];
        ...
        for (int row = 0; row < 10; row++) {
            for (int column = 0; column < 10; column++) {
                ...
                if((row==1 && (column >0 && column<9)) ||  ( (column==1 || column==8 )  && (row==2 || row==3)) || (row==4 &&( (column>0 && column<4) || (column>5 && column<9) )))
                {
                    x[forButton] = row;
                    y[forButton] = column;
                    hp[forButton] = 1;
                ...
                else if((row==8 && (column >0 && column<9)) ||  ( (column==1 || column==8 )  && (row==6 || row==7)) || (row==5 &&( (column>0 && column<4) || (column>5 && column<9) )))
                {
                    x[forButton] = row;
                    y[forButton] = column;
                    hp[forButton] = 2;
