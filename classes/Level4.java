...
public class Level4  extends Application{
    ...
    private int score = 0;
    private Button[] levelButtons = new Button[64];
    private int x[] = new int[64];
    private int y[] = new int[64];
    private int hp[] = new int[64];
    private int totalScore = 0;

    Label infoText = new Label();
    Label scoreText = new Label("" + totalScore);
    Label highScoreText = new Label("High Score: " + highScore4);
    ...
    public Level4(int highScore1, int highScore2, int highScore3, int highScore4, int highScore5) {
        ...
        for (int q = 0; q < levelButtons.length; q++) {
            ...
            if (event.getSource() == levelButtons[q]) {
                ...
                if (i == levelButtons.length) {
                    ...
                    if (totalScore > highScore4) {
                        highScore4 = totalScore;
                    }
                    highScoreText.setText("High Score:" + highScore4);
                }
            }
        }
    }
    Stage stage4 = new Stage();//high score verisini tutmak için
    public void NextLevel()
    {
        Level5 level5Scene = new Level5(highScore1, highScore2, highScore3, highScore4, highScore5);
        level5Scene.start(stage4);
    }
    public void start(Stage stage) {
        ...
        ///Üst taraf
        Label levelText = new Label("Level #4");
        ...
        Rectangle notDestroyedBoxes[] = new Rectangle[36];
        ...
        for (int row = 0; row < 10; row++) {
            for (int column = 0; column < 10; column++) {
                ...
                else if((9>row && row>4) && (column>0 &&column<9))
                {
                    x[forButton] = row;
                    y[forButton] = column;
                    hp[forButton] = 2;
